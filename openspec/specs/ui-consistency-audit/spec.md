# Spec: UI Consistency Audit

## Purpose

Ensures all inner-app pages consistently apply the Deep Ocean neo-brutalism design system — correct background colors, text tokens, border/shadow patterns, and no dark-mode variants.
